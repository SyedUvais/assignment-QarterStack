...
export default function NewHome() {
	...
	const [showDriveColumn, setShowDriveColumn] = useState(true);
	const [showProjectColumn, setShowProjectColumn] = useState(true);
		...
		<div className='homebody'>
			...
			<section>
				<div className='smallcontainer'>
					<div onClick={() => setShowTeamColumn(!showTeamColumn)} className='smalldivs' style={{ backgroundColor: '#FB896B', cursor:'pointer' }}>
				...
				<section style={{ width: showTeamColumn ? '100%' : '0%', height: showTeamColumn ? '100%' : '0px', transition: 'width 1s ease-out, height 0.5s ease-out', overflow: 'hidden', }}>
			...
			<section>
				<div className='smallcontainer'>
					<div onClick={() => setShowDriveColumn(!showDriveColumn)} className='smalldivs' style={{ backgroundColor: '#13B497', cursor:'pointer' }}>
				...
				<section style={{ width: showDriveColumn ? '100%' : '0%', height: showDriveColumn ? '100%' : '0px', transition: 'width 1s ease-out, height 0.5s ease-out', overflow: 'hidden', }}>
			...
			{/*operation section*/}
			{hasActivities && (<section style={{ marginBottom: '20px'}}>
				<div className='smallcontainer'>
						<div onClick={() => setShowProjectColumn(!showProjectColumn)} className='smalldivs' style={{ backgroundColor: '#13B497', cursor:'pointer' }}>
				...
				<section style={{ width: showProjectColumn ? '100%' : '0%', height: showProjectColumn ? '100%' : '0px', transition: 'width 0.5s ease-out, height 0.1s ease-out', overflow: 'hidden', }}>
					<div
